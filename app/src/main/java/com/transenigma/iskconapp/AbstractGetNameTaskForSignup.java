...
public abstract class AbstractGetNameTaskForSignup extends AsyncTask<Void, Void, Void>{

    protected signup mActivity;
    ...
    public AbstractGetNameTaskForSignup(signup mActivity, String mEmail, String mScope) {
                    ...
                    ParseUser.logInInBackground(mEmail,mEmail, new LogInCallback() {
                        public void done(ParseUser user, ParseException e) {
                            if (user != null) {
                                ...
                                signup.progressDialogSignup.dismiss();
                            } else {
